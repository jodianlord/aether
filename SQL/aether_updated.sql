...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 24, 2018 at 12:04 AM
-- Server version: 5.7.14
-- PHP Version: 7.0.10

CREATE DATABASE
IF NOT EXISTS `aether` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `aether`;
...
uuid`,
`bank
`, `transactionHash`, `verified`, `camimage`) VALUES
...
--
ALTER TABLE `transaction`
ADD CONSTRAINT `fk_user_from` FOREIGN KEY
(`user_from`) REFERENCES `user`
(`userid`),
ADD CONSTRAINT `fk_user_to` FOREIGN KEY
(`user_to`) REFERENCES `user`
(`userid`);
...
--
ALTER TABLE `userquiz`
ADD CONSTRAINT `quizid` FOREIGN KEY
(`iduserquiz`) REFERENCES `quiz`
(`quizid`) ON
DELETE NO ACTION ON
UPDATE NO ACTION,
ADD CONSTRAINT `userid` FOREIGN KEY
(`iduserquiz`) REFERENCES `user`
(`userid`) ON
DELETE NO ACTION ON
UPDATE NO ACTION;
