...
var geometry = new THREE.PlaneGeometry(50, 3, 32);
var material = new THREE.MeshBasicMaterial({ color: 0xffffff, side: THREE.DoubleSide, transparent: true, opacity: 0.3 });
